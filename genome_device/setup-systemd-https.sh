...
# Setup systemd service for genome device with HTTPS
echo "🔧 Setting up systemd service for genome device with HTTPS..."

# Copy service file
echo "📁 Copying service file..."
cp /home/ethereum/genome_device/genome-device.service /tmp/genome-device.service
sudo cp /tmp/genome-device.service /etc/systemd/system/
